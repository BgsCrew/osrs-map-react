...
describe('OSRSMap Component', () => {
  ...
  test('should render with custom dimensions', () => {
    render(<OSRSMap {...defaultProps} width="800px" height="600px" />);
  ...
  test('should render with custom className and style', () => {
    ...
    render(<OSRSMap {...defaultProps} className="custom-map" style={customStyle} />);
  ...
  test('should show coordinates when enabled and position is set', () => {
    ...
    render(
      <OSRSMap {...defaultProps} showCoordinates={true} onPositionChange={mockOnPositionChange} />
    );
  ...
  test('should render markers', () => {
    render(<OSRSMap {...defaultProps} markers={sampleMarkers} />);
  ...
  test('should handle map click events', () => {
    ...
    render(<OSRSMap {...defaultProps} onMapClick={mockOnMapClick} />);
  ...
  test('should handle marker click events', () => {
    ...
    render(<OSRSMap {...defaultProps} markers={sampleMarkers} onMarkerClick={mockOnMarkerClick} />);
  ...
  test('should handle position changes', () => {
    ...
    render(<OSRSMap {...defaultProps} onPositionChange={mockOnPositionChange} />);
  ...
  test('should handle center changes', () => {
    const { rerender } = render(<OSRSMap {...defaultProps} center={[3200, 3200]} />);

    // Change center
    rerender(<OSRSMap {...defaultProps} center={[3300, 3300]} />);
  ...
  test('should handle empty markers array', () => {
    render(<OSRSMap {...defaultProps} markers={[]} />);

    expect(screen.queryByTestId('marker')).not.toBeInTheDocument();
  });

  test('should handle undefined markers', () => {
    render(<OSRSMap {...defaultProps} markers={undefined} />);
  ...
  describe('Error Handling', () => {
    test('should handle invalid center coordinates gracefully', () => {
      ...
      render(<OSRSMap {...defaultProps} center={[NaN, NaN]} />);
  ...
  describe('Performance', () => {
    ...
    test('should handle large number of markers', () => {
      ...
      render(<OSRSMap {...defaultProps} markers={manyMarkers} />);
